...
""",
    ...
    def test_publication_reuses_shared_card_and_pill_materials(self) -> None:
        ...
        self.assertIn("color: var(--button-primary-color)", badge_material)
        self.assertIn("background: var(--button-primary-background)", badge_material)
        self.assertIn("border: 1px solid var(--button-primary-border)", badge_material)
        self.assertIn("box-shadow: var(--button-primary-shadow)", badge_material)
        self.assertIn("border-radius: var(--button-radius)", badge_material)
