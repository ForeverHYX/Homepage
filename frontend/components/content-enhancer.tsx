...
const HIGHLIGHT_LIGHT_ID = "hljs-light";
const HIGHLIGHT_DARK_ID = "hljs-dark";
const HIGHLIGHT_SCRIPT_ID = "hljs-script";
const HIGHLIGHT_SCRIPT_SRC =
  "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js";
const HIGHLIGHT_LIGHT_HREF =
  "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/github.min.css";
const HIGHLIGHT_DARK_HREF =
...
function ensureHighlightAssets(theme: string) {
  const lightSheet = ensureStylesheet(HIGHLIGHT_LIGHT_ID, HIGHLIGHT_LIGHT_HREF);
  const darkSheet = ensureStylesheet(HIGHLIGHT_DARK_ID, HIGHLIGHT_DARK_HREF);
  ...
  return new Promise<void>((resolve, reject) => {
    ...
    let script = document.getElementById(HIGHLIGHT_SCRIPT_ID) as HTMLScriptElement | null;
    if (!script) {
    ...
    const fail = () => reject(new Error("Failed to load highlight.js"));
...
export function ContentEnhancer() {
  ...
  useEffect(() => {
    ...
    ensureHighlightAssets(theme)
      ...
      .catch(() => {
        if (!cancelled) {
          console.error("Failed to load content enhancement assets");
        }
      });
